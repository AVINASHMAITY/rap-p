CLASS zcl_pdakm_team_modl DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_pdakm_team_modl IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
     DATA
        lt_team TYPE STANDARD TABLE OF ZDAKM_TEAM  WITH EMPTY KEY.
    ...
    lt_team =
        VALUE #( ( user_id  = 'P0020'
                 ...
                 ( user_id  = 'P0028'
                   ...
                   team     = 'Wasteland'
                   leader   = 'P0025' ) ).
    DELETE FROM ZDAKM_TEAM.
    INSERT ZDAKM_TEAM FROM TABLE @lt_team.
    COMMIT WORK.
  ENDMETHOD.
