CLASS zclakm_rebuild_intf_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zclakm_rebuild_intf_data IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
  zclakm_rebuild_intf_data=>rebuild_data(  ).
  ENDMETHOD.

  METHOD rebuild_data.
  DATA: lt_data TYPE SORTED TABLE OF ZDAKM_CNAME WITH UNIQUE KEY name.
  ...
  lt_data = VALUE #(  ( name = 'SAP'
    ...
    INSERT ZDAKM_CNAME FROM TABLE @lt_data.
    COMMIT WORK.
